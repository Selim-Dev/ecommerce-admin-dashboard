...
const New = ({ title, input }) => {
  ...
  // const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYyNDIwYTgxMmUzZTkwMjBiMDlkNDdiMiIsImlhdCI6MTY0ODQ5NTQyOCwiZXhwIjoxNjU2MjcxNDI4fQ.9w71qEOURIF0NXcjnmP3Y6JEu9nYYIHRRExkZSRppEI"
